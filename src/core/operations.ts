...
export interface OperationContext {
  ...
  remote: boolean;
  /**
   * #1061: transport marker for auth-less remote surfaces. Only the stdio MCP
...
const whoami: Operation = {
  ...
  description:
    ...
    'Throws unknown_transport when the context is ambiguous (remote=true ' +
    'without auth and not a known auth-less transport) — fail-closed posture ' +
