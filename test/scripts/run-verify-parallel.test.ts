...
describe.skipIf(process.platform === "win32")("run-verify-parallel.sh — no-timeout-binary fallback rc capture (regression)", () => {
  ...
  // installed. Windows skips this POSIX-only harness: unprivileged symlink
  // creation requires Developer Mode and Git Bash cannot faithfully model the
  // target platforms' process/watchdog semantics.
